...
public sealed class RetryPolicyAnalyzerTests
{
    ...
    public void SupportedDiagnostics_ShouldContainRetryPolicyRule()
    {
        ...
        Assert.Contains(analyzer.SupportedDiagnostics, d => d.Id == DiagnosticIds.ResilienceRetryPolicyMissing);
    }
    ...
    private static async Task<ImmutableArray<Diagnostic>> GetDiagnosticsAsync(string source)
    {
        ...
        return await compilation.WithAnalyzers([new RetryPolicyAnalyzer()]).GetAnalyzerDiagnosticsAsync();
    }
}
