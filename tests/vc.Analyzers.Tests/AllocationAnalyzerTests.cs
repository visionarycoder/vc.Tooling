...
public sealed class AllocationAnalyzerTests
{
    ...
    public void SupportedDiagnostics_ShouldContainAllocationRule()
    {
        ...
        Assert.Contains(analyzer.SupportedDiagnostics, d => d.Id == DiagnosticIds.PerfAllocationInHotPath);
    }
    ...
    private static async Task<ImmutableArray<Diagnostic>> GetDiagnosticsAsync(string source)
    {
        ...
        return await compilation.WithAnalyzers([new AllocationAnalyzer()]).GetAnalyzerDiagnosticsAsync();
    }
}
