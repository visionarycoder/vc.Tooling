...
public sealed class ImmutabilityAnalyzerTests
{
    ...
    {
        var diagnostics = await GetDiagnosticsAsync("namespace SampleApp; public record Sample(string Name);");
    ...
    private static async Task<ImmutableArray<Diagnostic>> GetDiagnosticsAsync(string source)
    {
        ...
        return await compilation.WithAnalyzers([new ImmutabilityAnalyzer()]).GetAnalyzerDiagnosticsAsync();
    }
}
