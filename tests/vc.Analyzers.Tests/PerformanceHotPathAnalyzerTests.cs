...
public sealed class PerformanceHotPathAnalyzerTests
{
    ...
    public void SupportedDiagnostics_ShouldContainLinqHotPathRule()
    {
        ...
        Assert.Contains(analyzer.SupportedDiagnostics, d => d.Id == DiagnosticIds.PerfLinqInHotPath);
    }
    ...
    private static async Task<ImmutableArray<Diagnostic>> GetDiagnosticsAsync(string source)
    {
        ...
        return await compilation.WithAnalyzers([new PerformanceHotPathAnalyzer()]).GetAnalyzerDiagnosticsAsync();
    }
}
