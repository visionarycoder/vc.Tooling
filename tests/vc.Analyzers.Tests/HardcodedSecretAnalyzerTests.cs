...
public sealed class HardcodedSecretAnalyzerTests
{
    ...
    public void SupportedDiagnostics_ShouldContainHardcodedSecretRule()
    {
        ...
        Assert.Contains(collection: analyzer.SupportedDiagnostics, filter: d => d.Id == DiagnosticIds.SecurityHardcodedSecret);
    }
    ...
    private static async Task<ImmutableArray<Diagnostic>> GetDiagnosticsAsync(string source)
    {
        ...
        return await compilation.WithAnalyzers(analyzers: [new HardcodedSecretAnalyzer()]).GetAnalyzerDiagnosticsAsync();
    }
}
