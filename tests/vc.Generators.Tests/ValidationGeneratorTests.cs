...
/// <summary>
/// Tests for ValidationGenerator Phase 4 Bundle 8.
/// Validates that the generator produces correct validator classes.
/// </summary>
public sealed class ValidationGeneratorTests
{
    ...
    public void Generator_Executes_WithoutThrowingException()
    {
        ...
        var generator = new VisionaryCoder.Tooling.Generators.ValidationGenerator();
    ...
    [Fact]
    public void Generator_GeneratedCode_ContainsValidatorClass()
    {
        // Arrange
        var source = CreateSourceWithAttribute();
        var compilation = CreateCompilation(source);
        ...
        Assert.Contains("public sealed partial class OrderValidator", generatedText);
    }

    [Fact]
    public void Generator_ProducesValidateMethod()
    {
        // Arrange
        var source = CreateSourceWithAttribute();
        var compilation = CreateCompilation(source);
        ...
        // Assert
        Assert.Contains("public ValidationResult Validate(Order target)", generatedText);
        Assert.Contains("Validates a Order object", generatedText);
    }

    [Fact]
    public void Generator_ProducesValidateAsyncMethod()
    {
        // Arrange
        var source = CreateSourceWithAttribute();
        var compilation = CreateCompilation(source);
        ...
        // Assert
        Assert.Contains("public Task<ValidationResult> ValidateAsync(Order target, CancellationToken cancellationToken = default)", generatedText);
        Assert.Contains("Asynchronously validates a Order object", generatedText);
    }

    [Fact]
    public void Generator_ProducesValidationResultClass()
    {
        // Arrange
        var source = CreateSourceWithAttribute();
        var compilation = CreateCompilation(source);
        ...
        // Assert
        Assert.Contains("public sealed class ValidationResult", generatedText);
        Assert.Contains("public bool IsValid { get; }", generatedText);
        Assert.Contains("public IReadOnlyList<string> Errors { get; }", generatedText);
    }

    [Fact]
    public void Generator_ProducesValidationResultFactoryMethods()
    {
        // Arrange
        var source = CreateSourceWithAttribute();
        var compilation = CreateCompilation(source);
        ...
        // Assert
        Assert.Contains("public static ValidationResult Success()", generatedText);
        Assert.Contains("public static ValidationResult Failure(string error)", generatedText);
        Assert.Contains("public static ValidationResult Failure(IEnumerable<string> errors)", generatedText);
    }

    [Fact]
    public void Generator_ProducesNullValidation()
    {
        // Arrange
        var source = CreateSourceWithAttribute();
        var compilation = CreateCompilation(source);
        ...
        // Assert
        Assert.Contains("if (target == null)", generatedText);
        Assert.Contains("return ValidationResult.Failure(\"Target object cannot be null.\");", generatedText);
    }

    [Fact]
    public void Generator_ProducesErrorListHandling()
    {
        // Arrange
        var source = CreateSourceWithAttribute();
        var compilation = CreateCompilation(source);
        ...
        // Assert
        Assert.Contains("var errors = new List<string>();", generatedText);
        Assert.Contains("return errors.Any()", generatedText);
    }
    ...
    [Fact]
    public void Generator_MultipleValidators_GeneratesSeparateFiles()
    {
        // Arrange
        var source = """
            namespace Vc.Generators.Abstractions.Design
            {
                ...
                public sealed class VcValidatorAttribute : System.Attribute { }
            }

            namespace Sample.Domain.Entities
            {
                [Vc.Generators.Abstractions.Design.VcValidatorAttribute]
                public class Order { }
    ...
    public void Generator_GeneratesDeterministicOutput_Reproducible()
    {
        ...
        var generator1 = new VisionaryCoder.Tooling.Generators.ValidationGenerator();
        var generator2 = new VisionaryCoder.Tooling.Generators.ValidationGenerator();
    ...
    private Compilation CreateCompilation(string source)
    {
        ...
        var vcAbstractionsAssemblyPath = typeof(Vc.Generators.Abstractions.Design.VcValidatorAttribute).Assembly.Location;
