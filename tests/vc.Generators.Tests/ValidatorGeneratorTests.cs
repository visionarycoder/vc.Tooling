using VisionaryCoder.Generators.Common;
using Xunit;
...
public sealed class ValidatorGeneratorTests
{
    ...
    {
        var attr = "namespace Vc.Generators.Abstractions.Design; [AttributeUsage(AttributeTargets.Class)] public sealed class VcValidatorAttribute : Attribute {}";
        var src = "using Vc.Generators.Abstractions.Design; namespace Design; [VcValidator] public partial class UserValidator {}";
