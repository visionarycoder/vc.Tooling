...
public sealed class ExceptionSafetyBroadCatchCodeFixTests
{
    ...
    public async Task RegisterCodeFixesAsync_ShouldAddSuppressMessageAttributeForBroadCatch()
    {
        ...
        var diagnostic = Diagnostic.Create(
            descriptor: new DiagnosticDescriptor(
                ...
                messageFormat: "Catch block in method '{0}' catches broad exception type; use specific exception type.",
                category: "Design",
        ...
        Assert.Contains(expectedSubstring: DiagnosticIds.DesignExceptionSafetyBroadCatch, actualString: updatedText.ToString());
    }
    ...
    private static async Task<Document> CreateDocumentAsync(string source)
    {
        ...
        return workspace.AddDocument(projectId: project.Id, name: "ExceptionSafetyBroadCatch.cs", text: SourceText.From(text: source));
    }
}
