...
public sealed class RepositoryQueryableLeakCodeFixTests
{
    ...
    public async Task RegisterCodeFixesAsync_ShouldAddSuppressMessageAttributeForQueryableLeakage()
    {
        ...
        Assert.Contains(expectedSubstring: DiagnosticIds.DistributedRepositoryQueryableLeakage, actualString: updatedText.ToString());
    }
    ...
    private static async Task<Document> CreateDocumentAsync(string source)
    {
        ...
        return workspace.AddDocument(projectId: project.Id, name: "RepositoryQueryableLeak.cs", text: SourceText.From(text: source));
    }
}