...
public sealed class RepositoryDesignCodeFixTests
{
    ...
    public async Task RegisterCodeFixesAsync_ShouldAddSuppressMessageAttributeForRepositoryMissing()
    {
        ...
        var classNode = root!
            ...
            .First(node => node.Identifier.Text == "UserAccessor");

        var diagnostic = Diagnostic.Create(
            new DiagnosticDescriptor(
                DiagnosticIds.DataDesignRepositoryMissing,
                "Repository missing",
                "Type '{0}' should implement repository pattern.",
                "Data",
        ...
        Assert.Contains(DiagnosticIds.DataDesignRepositoryMissing, updatedText.ToString());
    }
    ...
    private static async Task<Document> CreateDocumentAsync(string source)
    {
        ...
        return workspace.AddDocument(project.Id, "RepositoryDesign.cs", SourceText.From(source));
    }
}
