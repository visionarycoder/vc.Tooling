...
public sealed class PerformanceAllocationCodeFixTests
{
    ...
    public async Task RegisterCodeFixesAsync_ShouldAddSuppressMessageForAllocationInHotPath()
    {
        ...
        var diagnostic = Diagnostic.Create(
            descriptor: new DiagnosticDescriptor(id: DiagnosticIds.PerfAllocationInHotPath, title: "Allocation in hot path",
                messageFormat: "Allocation in performance-critical code.", category: "Performance",
        ...
        Assert.Contains(expectedSubstring: DiagnosticIds.PerfAllocationInHotPath, actualString: updatedText.ToString());
    }
