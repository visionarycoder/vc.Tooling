...
public sealed class ResilienceTimeoutCodeFixTests
{
    ...
    public async Task RegisterCodeFixesAsync_ShouldAddSuppressMessageForMissingTimeout()
    {
        ...
        var diagnostic = Diagnostic.Create(
            new DiagnosticDescriptor(DiagnosticIds.ResilienceTimeoutMissing, "Missing timeout",
                "External call '{0}' is not wrapped in a timeout.", "Resilience",
                DiagnosticSeverity.Warning, isEnabledByDefault: true),
            methodNode.Identifier.GetLocation(), "FetchData");
        ...
        Assert.Contains(DiagnosticIds.ResilienceTimeoutMissing, updatedText.ToString());
    }
