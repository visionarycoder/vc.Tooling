...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(CyclicDependencyCodeFix))]
[Shared]
public sealed class CyclicDependencyCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.ArchCyclicDependency);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Cycle acknowledged; refactor tracked separately.")));
