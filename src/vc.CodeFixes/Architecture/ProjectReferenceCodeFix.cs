...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ProjectReferenceCodeFix))]
[Shared]
public sealed class ProjectReferenceCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.ArchProjectReferenceViolation);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Reference retained temporarily for migration.")));
