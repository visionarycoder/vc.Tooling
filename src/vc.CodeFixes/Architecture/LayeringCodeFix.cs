...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(LayeringCodeFix))]
[Shared]
public sealed class LayeringCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.ArchLayeringViolation);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Reviewed manually; architectural refactor planned.")));
