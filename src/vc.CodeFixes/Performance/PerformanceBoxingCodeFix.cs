...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(PerformanceBoxingCodeFix))]
[Shared]
public sealed class PerformanceBoxingCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.PerfBoxing);
        ...
        var args = SyntaxFactory.SeparatedList(new[]
        {
            ...
            SyntaxFactory.AttributeArgument(SyntaxFactory.NameEquals("Justification"), null,
                SyntaxFactory.LiteralExpression(SyntaxKind.StringLiteralExpression,
                    SyntaxFactory.Literal("Boxing is intentional or infrequent enough to not impact performance.")))
        });
