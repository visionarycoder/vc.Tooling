...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(PerformanceLinqCodeFix))]
[Shared]
public sealed class PerformanceLinqCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.PerfLinqInHotPath);
        ...
        var args = SyntaxFactory.SeparatedList(new[]
        {
            ...
            SyntaxFactory.AttributeArgument(SyntaxFactory.NameEquals("Justification"), null,
                SyntaxFactory.LiteralExpression(SyntaxKind.StringLiteralExpression,
                    SyntaxFactory.Literal("LINQ usage is acceptable here; this code path is not performance-critical.")))
        });
