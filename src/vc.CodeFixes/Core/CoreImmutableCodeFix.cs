...
namespace Vc.CodeFixes.Core;

[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(CoreImmutableCodeFix))]
[Shared]
public sealed class CoreImmutableCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.CoreImmutableMissing);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        var categoryArgument = SyntaxFactory.AttributeArgument(
            SyntaxFactory.LiteralExpression(SyntaxKind.StringLiteralExpression, SyntaxFactory.Literal("Core")));
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Immutability is enforced through encapsulation or documentation.")));
