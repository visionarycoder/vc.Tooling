...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ExceptionSafetyEmptyCatchCodeFix))]
[Shared]
public sealed class ExceptionSafetyEmptyCatchCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.DesignExceptionSafetyEmptyCatch);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Empty catch is intentional; exception is handled by continuation or outer handler.")));
