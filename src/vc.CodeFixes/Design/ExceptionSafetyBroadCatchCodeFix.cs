...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ExceptionSafetyBroadCatchCodeFix))]
[Shared]
public sealed class ExceptionSafetyBroadCatchCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.DesignExceptionSafetyBroadCatch);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        var categoryArgument = SyntaxFactory.AttributeArgument(
            SyntaxFactory.LiteralExpression(SyntaxKind.StringLiteralExpression, SyntaxFactory.Literal("Design")));
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Broad exception catch is necessary for compatibility with legacy code or third-party dependencies.")));
