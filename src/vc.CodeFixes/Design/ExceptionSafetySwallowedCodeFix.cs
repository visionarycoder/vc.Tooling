...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ExceptionSafetySwallowedCodeFix))]
[Shared]
public sealed class ExceptionSafetySwallowedCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.DesignExceptionSafetySwallowed);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Exception is intentionally swallowed; error is handled by recovery strategy or continuation.")));
