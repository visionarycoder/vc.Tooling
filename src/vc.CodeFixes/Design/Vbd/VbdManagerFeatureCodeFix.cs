...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(VbdManagerFeatureCodeFix))]
[Shared]
public sealed class VbdManagerFeatureCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.VbdManagerVaultFeatureSpecificLogic);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Reviewed manually; policy/strategy extraction planned.")));
