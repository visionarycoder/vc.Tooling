...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(VbdAccessSchemaCodeFix))]
[Shared]
public sealed class VbdAccessSchemaCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.VbdAccessVaultSchemaMappingMissing);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Reviewed manually; mapping abstraction will be introduced.")));
