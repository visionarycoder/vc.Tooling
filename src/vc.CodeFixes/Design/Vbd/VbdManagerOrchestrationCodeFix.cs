...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(VbdManagerOrchestrationCodeFix))]
[Shared]
public sealed class VbdManagerOrchestrationCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.VbdManagerVaultMissingOrchestration);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Reviewed manually; orchestration behavior will be introduced.")));
