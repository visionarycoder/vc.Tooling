...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(VbdManagerCodeFix))]
[Shared]
public sealed class VbdManagerCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.VbdManagerVaultUnstableContract);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Reviewed manually; planned contract refactor.")));
