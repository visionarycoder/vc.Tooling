...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(VbdAccessBoundaryCodeFix))]
[Shared]
public sealed class VbdAccessBoundaryCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.VbdAccessVaultBoundaryViolation);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Reviewed manually; planned boundary inversion refactor.")));
