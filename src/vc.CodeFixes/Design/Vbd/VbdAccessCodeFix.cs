...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(VbdAccessCodeFix))]
[Shared]
public sealed class VbdAccessCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.VbdAccessVaultBusinessLogicLeakage);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Reviewed manually; planned extraction to manager/engine.")));
