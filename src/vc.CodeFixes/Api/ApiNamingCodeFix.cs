...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ApiNamingCodeFix))]
[Shared]
public sealed class ApiNamingCodeFix : CodeFixProvider
{
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        var categoryArgument = SyntaxFactory.AttributeArgument(
            SyntaxFactory.LiteralExpression(SyntaxKind.StringLiteralExpression, SyntaxFactory.Literal("Api")));
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Endpoint naming convention is intentional for backward compatibility.")));
