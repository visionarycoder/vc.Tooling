...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ApiVersioningMissingCodeFix))]
[Shared]
public sealed class ApiVersioningMissingCodeFix : CodeFixProvider
{
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("API versioning is handled through route prefixes or content negotiation.")));
