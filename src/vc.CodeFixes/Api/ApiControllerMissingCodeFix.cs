...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ApiControllerMissingCodeFix))]
[Shared]
public sealed class ApiControllerMissingCodeFix : CodeFixProvider
{
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Controller is implemented using alternative API pattern (minimal APIs, gRPC, etc.).")));
