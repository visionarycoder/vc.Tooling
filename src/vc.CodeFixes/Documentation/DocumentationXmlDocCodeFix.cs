...
namespace Vc.CodeFixes.Documentation;

[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(DocumentationXmlDocCodeFix))]
[Shared]
public sealed class DocumentationXmlDocCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.DocumentationMissingXmlDoc);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        var categoryArgument = SyntaxFactory.AttributeArgument(
            SyntaxFactory.LiteralExpression(SyntaxKind.StringLiteralExpression, SyntaxFactory.Literal("Documentation")));
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Member is self-documenting or documentation is provided externally.")));
