...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(EventSourcingUnusedEventCodeFix))]
[Shared]
public sealed class EventSourcingUnusedEventCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.DistributedEventSourcingUnusedEvent);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Event is reserved for future use in event sourcing strategy.")));
