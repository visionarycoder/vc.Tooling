...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(EventSourcingMissingApplyCodeFix))]
[Shared]
public sealed class EventSourcingMissingApplyCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.DistributedEventSourcingMissingApply);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Apply method implementation deferred to derived aggregate.")));
