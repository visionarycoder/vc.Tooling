...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RepositoryAsyncCodeFix))]
[Shared]
public sealed class RepositoryAsyncCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.DistributedRepositoryAsyncMissing);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Synchronous contract retained for legacy integration.")));
