...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RepositoryQueryableLeakCodeFix))]
[Shared]
public sealed class RepositoryQueryableLeakCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.DistributedRepositoryQueryableLeakage);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Queryable contract required by current data pipeline.")));
