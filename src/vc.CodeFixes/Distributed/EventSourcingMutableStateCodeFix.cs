...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(EventSourcingMutableStateCodeFix))]
[Shared]
public sealed class EventSourcingMutableStateCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.DistributedEventSourcingMutableState);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("State mutations are audited separately and approved for legacy compatibility.")));
