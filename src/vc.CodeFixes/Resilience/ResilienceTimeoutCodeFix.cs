...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ResilienceTimeoutCodeFix))]
[Shared]
public sealed class ResilienceTimeoutCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.ResilienceTimeoutMissing);
        ...
        var args = SyntaxFactory.SeparatedList(new[]
        {
            ...
            SyntaxFactory.AttributeArgument(SyntaxFactory.NameEquals("Justification"), null,
                SyntaxFactory.LiteralExpression(SyntaxKind.StringLiteralExpression,
                    SyntaxFactory.Literal("Timeout is enforced by CancellationToken or infrastructure pipeline.")))
        });
