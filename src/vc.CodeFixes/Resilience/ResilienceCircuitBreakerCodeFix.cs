...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ResilienceCircuitBreakerCodeFix))]
[Shared]
public sealed class ResilienceCircuitBreakerCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.ResilienceCircuitBreakerMissing);
        ...
        var args = SyntaxFactory.SeparatedList(new[]
        {
            ...
            SyntaxFactory.AttributeArgument(SyntaxFactory.NameEquals("Justification"), null,
                SyntaxFactory.LiteralExpression(SyntaxKind.StringLiteralExpression,
                    SyntaxFactory.Literal("Circuit breaker is applied at the registration or gateway layer.")))
        });
