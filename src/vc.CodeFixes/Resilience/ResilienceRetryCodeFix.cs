...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ResilienceRetryCodeFix))]
[Shared]
public sealed class ResilienceRetryCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.ResilienceRetryPolicyMissing);
        ...
        var args = SyntaxFactory.SeparatedList(new[]
        {
            ...
            SyntaxFactory.AttributeArgument(SyntaxFactory.NameEquals("Justification"), null,
                SyntaxFactory.LiteralExpression(SyntaxKind.StringLiteralExpression,
                    SyntaxFactory.Literal("Retry policy is handled at the infrastructure or gateway layer.")))
        });
