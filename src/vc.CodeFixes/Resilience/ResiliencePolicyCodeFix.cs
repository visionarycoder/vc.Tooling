...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ResiliencePolicyCodeFix))]
[Shared]
public sealed class ResiliencePolicyCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.ResiliencePolicyMissing);
        ...
        var args = SyntaxFactory.SeparatedList(new[]
        {
            ...
            SyntaxFactory.AttributeArgument(SyntaxFactory.NameEquals("Justification"), null,
                SyntaxFactory.LiteralExpression(SyntaxKind.StringLiteralExpression,
                    SyntaxFactory.Literal("Resilience policy is applied at the composition root or calling layer.")))
        });
