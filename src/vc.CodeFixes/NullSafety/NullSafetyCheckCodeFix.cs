...
namespace Vc.CodeFixes.NullSafety;

[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(NullSafetyCheckCodeFix))]
[Shared]
public sealed class NullSafetyCheckCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.NullSafetyMissingCheck);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        var categoryArgument = SyntaxFactory.AttributeArgument(
            SyntaxFactory.LiteralExpression(SyntaxKind.StringLiteralExpression, SyntaxFactory.Literal("NullSafety")));
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Null safety is enforced through preconditions or design contract.")));
