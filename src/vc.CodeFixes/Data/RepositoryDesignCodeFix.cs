...
namespace Vc.CodeFixes.Data;

[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(RepositoryDesignCodeFix))]
[Shared]
public sealed class RepositoryDesignCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.DataDesignRepositoryMissing);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        var categoryArgument = SyntaxFactory.AttributeArgument(
            SyntaxFactory.LiteralExpression(SyntaxKind.StringLiteralExpression, SyntaxFactory.Literal("Data")));
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Repository pattern is implemented using alternative persistence strategy.")));
