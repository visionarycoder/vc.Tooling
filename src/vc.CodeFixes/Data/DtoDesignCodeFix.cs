...
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(DtoDesignCodeFix))]
[Shared]
public sealed class DtoDesignCodeFix : CodeFixProvider
{
    public override ImmutableArray<string> FixableDiagnosticIds =>
        ImmutableArray.Create(DiagnosticIds.DataDesignDtoMissing);
    ...
    private static AttributeListSyntax BuildSuppressionAttribute(string diagnosticId)
    {
        ...
        var justificationArgument = SyntaxFactory.AttributeArgument(
            ...
            SyntaxFactory.LiteralExpression(
                ...
                SyntaxFactory.Literal("Data transfer object is implemented using alternative mapping strategy.")));
