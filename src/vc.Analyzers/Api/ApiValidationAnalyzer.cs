...
{
    private static readonly ImmutableArray<IAnalyzerRule> Rules = [new ApiValidationRule()];

    public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics => [..Rules.Select(selector: r => r.Descriptor)];
